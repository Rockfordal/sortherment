        ...
        return function (v) {
            return function (s) {
                return function (v1) {
                    ...
                    }) ])([  ]), React_DOM.text(s.description), React_DOM.text(Prelude.show(Prelude.showInt)(s.quantity)), React_DOM.a([ React_DOM_Props.className("btn btn-danger pull-right"), React_DOM_Props.title("Ta bort"), React_DOM_Props.onClick(function (v2) {
                    ...
                    return function (c) {
                        var handleKeyPress = function (v) {
                            return function (text) {
                                if (v === 13) {
                                    return dispatch(new NewTask(text));
                                };
                                if (v === 27) {
                        ...
                        var handleKeyPres = function (v) {
                            return function (text) {
                                ...
                                if (v === 27) {
                                    return dispatch(new SetEditQuantity(""));
                                };
                                return Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit);
                            };
                        };
                        return [ React_DOM.table([ React_DOM_Props.className("table table-striped") ])([ React_DOM["thead'"]([ React_DOM.th([ React_DOM_Props.className("col-md-1") ])([  ]), React_DOM.th([ React_DOM_Props.className("col-md-5") ])([ React_DOM.text("Artikel") ]), React_DOM.th([ React_DOM_Props.className("col-md-5") ])([ React_DOM.text("Antal") ]), React_DOM.th([ React_DOM_Props.className("col-md-1") ])([  ]) ]), React_DOM["tbody'"](Prelude["<>"](Prelude.semigroupArray)([ React_DOM["tr'"]([ React_DOM["td'"]([  ]), React_DOM["td'"]([ React_DOM.input([ React_DOM_Props.className("form-control"), React_DOM_Props.placeholder("ny beskrivning"), React_DOM_Props.value(s.editText), React_DOM_Props.onKeyUp(function (e) {
                            return handleKeyPress((Unsafe_Coerce.unsafeCoerce(e)).keyCode)((Unsafe_Coerce.unsafeCoerce(e)).target.value);
                            ...
                            return handleKeyPres((Unsafe_Coerce.unsafeCoerce(e)).keyCode)((Unsafe_Coerce.unsafeCoerce(e)).target.value);
                        }), React_DOM_Props.onChange(function (e) {
                    ...
                    return function (k) {
                        if (v instanceof TaskAction && v.value1 instanceof Components_Task.RemoveTask) {
                            return k((function () {
                                ...
                                $35.tasks = Data_Maybe.fromMaybe(state.tasks)(Data_List.deleteAt(v.value0)(state.tasks));
                                return $35;
                            })());
                        };
                        ...
                        if (v instanceof SetEditQuantity) {
                            return k((function () {
                                var $42 = {};
                                for (var $43 in state) {
                                    if (state.hasOwnProperty($43)) {
                                        $42[$43] = state[$43];
                                    };
                                };
                                $42.editQuantity = v.value0;
                                return $42;
                            })());
                        };
                    ...
                    return function (v1) {
                        var filter_ = function (f) {
                            return React_DOM.button([ React_DOM_Props.className((function () {
                                var $48 = Prelude["=="](Data_Filter.eqFilter)(f)(s.filter);
                                if ($48) {
                                ...
                                throw new Error("Failed pattern match at Components.TaskList line 95, column 7 - line 96, column 7: " + [ $48.constructor.name ]);
                    ...
                    return function (k) {
                        if (v instanceof NewTask) {
                            return k((function () {
                                ...
                                $54.tasks = new Data_List.Cons(Components_Task.initialTask(v.value0), state.tasks);
                                return $54;
                            })());
                        };
                        return Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit);
    ...
    var applyFilter = function (filter) {
        var matches = function (v) {
            return function (t) {
                ...
                throw new Error("Failed pattern match at Components.TaskList line 114, column 5 - line 115, column 5: " + [ v.constructor.name, t.constructor.name ]);
            };
        };
                ...
                return function (p) {
                    return function (s) {
                        return function (c) {
                            ...
                            throw new Error("Failed pattern match at Components.TaskList line 70, column 1 - line 71, column 1: " + [ $62.constructor.name ]);
                        };
                    };
                };
            };
